import re
import requests
## web tabanlı işlemlerimizi halletmek veya yönlendirmek için gerekli olam modüldür

##Öncelikle verilerimizi alaacağımız linki url olarak yada link olarak tanımladık şimdide request modülünün .get özelliği ile verimizi site adlı değişkene tanımladım


url = "http://www.havadurumu15gunluk.net/havadurumu/balikesir-hava-durumu-15-gunluk.html"
...
r_aciklama = '<img src="/havadurumu/images/trans.gif" alt="Balıkesir Hava durumu 15 günlük" width="1" height="1" />(.*)</div>'
